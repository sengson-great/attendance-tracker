...
const translations = {
    ...
    schoolStartTime: 'ម៉ោងចាប់ផ្តើមសាលារៀន',
    ...
    qrNeedsHttps: 'តំណ QR នេះមិនមែនជា HTTPS ទេ។ កាមេរ៉ាទូរស័ព្ទអាចបើកទំព័របាន ប៉ុន្តែ browser នឹងមិនអនុញ្ញាតឱ្យប្រើ GPS location លើ HTTP ឡើយ។ សូមប្រើ HTTPS domain មុនបោះពុម្ព QR។',
...
${attendanceList || 'មិនទាន់មានការចុះវត្តមាននៅឡើយទេ'}
    ...
    const printSchoolQR = () => {
        ...
        const isSecureScanUrl = window.location.protocol === 'https:';

        if (!isSecureScanUrl) {
            alert(translations.qrNeedsHttps);
        }
              ...
              <body>
                <div class="container">
                  ...
                  <div class="instructions">
                    ...
                    <ol>
                      <li>ដាក់ QR code នេះនៅច្រកចូលសាលារៀន</li>
                      <li>បុគ្គលិកស្កេនជាមួយកាមេរ៉ាទូរស័ព្ទ</li>
                      <li>ជ្រើសរើសឈ្មោះរបស់ពួកគេពីបញ្ជី</li>
                      <li>ចុះវត្តមានរួចរាល់! ✅</li>
                    </ol>
                    <p style="margin-top: 15px; font-size: 14px; color: #666;">
                      សាលារៀនចាប់ផ្តើមនៅម៉ោង ${lateConfig.schoolStartHour}:${lateConfig.schoolStartMinute.toString().padStart(2, '0')} ព្រឹក
                    </p>
                  </div>
